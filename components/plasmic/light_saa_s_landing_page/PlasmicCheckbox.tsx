...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: 2AZ2I8PqeO6B/css

import Check2Icon from "./icons/PlasmicIcon__Check2"; // plasmic-import: 3NOjPigDlwIr/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: E-UEbM6XIuAx/icon
...
function PlasmicCheckbox__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <Check2Icon
          className={classNames(projectcss.all, sty.svg__bCbqu)}
          role={"img"}
        />

        <MinusIcon
          className={classNames(projectcss.all, sty.svg__yy023)}
          role={"img"}
        />
      </div>
      {renderPlasmicSlot({
