...
import Label from "../../Label"; // plasmic-import: PO_RxFUhnFM7/component
import TextInput2 from "../../TextInput2"; // plasmic-import: bL7McdMcbAz3/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: EUFf3RTp7jMy/component
import Description from "../../Description"; // plasmic-import: 5MlmIBHiFZ20/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: upKX6z7bifjz/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__iyr5D, {
          [sty.freeBoxiconEnd__iyr5DzwYlU]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__iyr5DvLcJg]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__iyr5DfrcYb]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__tgSuG, {
            [sty.freeBoxiconStart__tgSuGvLcJg]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__tgSuGfrcYb]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__bD5Ov)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__o1Xnh, {
            [sty.freeBoxiconEnd__o1XnhZwYlU]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__o1XnhVLcJg]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__dwrFc)}
                role={"img"}
              />
            ),
