...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: X70q2Fd0GHa9/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: UMqDupLuNahk/css
  ...
  return (
    <BaseDialogTrigger
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__o6Iin)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__mhI6Z)}
            label={"Open Popover"}
          />
        ),
