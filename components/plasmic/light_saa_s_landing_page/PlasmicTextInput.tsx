...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: RYnCW_PWn357/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvg2Icon
              className={classNames(projectcss.all, sty.svg__rbvEa)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg___0A8Hj)}
              role={"img"}
            />
          ),
