...
import SliderThumb from "../../SliderThumb"; // plasmic-import: IXW3aTpYsq8v/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: EBs5gvfsSwXa/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__atxL)}
      >
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__czSm9)}>
        <div
