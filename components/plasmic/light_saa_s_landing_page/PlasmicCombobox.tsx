...
import MenuPopover from "../../MenuPopover"; // plasmic-import: I5nbcopDPc5s/component
import MenuItem from "../../MenuItem"; // plasmic-import: Pprs0qZAKpHo/component
import MenuSection from "../../MenuSection"; // plasmic-import: gwVG3DKCPLh7/component
...
import sty from "./PlasmicCombobox.module.css"; // plasmic-import: SrHVuWa8yzAP/css
...
function PlasmicCombobox__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox___3TUo)}>
        {(() => {
          const child$Props = {
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox__ylr0R)}>
            <ChevronDownIcon
