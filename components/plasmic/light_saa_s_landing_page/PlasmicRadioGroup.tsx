...
import Radio from "../../Radio"; // plasmic-import: hYYKZFpkKMwI/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: PyVh7IehCDQk/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__is9Ah)}
          >
            <Radio
              className={classNames("__wab_instance", sty.radio__ba686)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__xxN5H)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__wxLM)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
