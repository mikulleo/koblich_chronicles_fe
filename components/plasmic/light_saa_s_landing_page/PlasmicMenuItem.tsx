...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: Pprs0qZAKpHo/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___0Zr6I)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox___6ZwM4)}>
            <div
              className={classNames(
                projectcss.all,
