...
import Checkbox from "../../Checkbox"; // plasmic-import: 2AZ2I8PqeO6B/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: DOhz-Ak96swn/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__bbeTj)}
          >
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__bwK6B)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__ecOlj)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__iw4Wi)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
